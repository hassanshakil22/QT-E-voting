...
static constexpr auto qt_meta_stringdata_ZN5graphE = QtMocHelpers::stringData(
    "graph"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5graphE[] = {
...
Q_CONSTINIT const QMetaObject graph::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5graphE.offsetsAndSizes,
    qt_meta_data_ZN5graphE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5graphE_t,
        // Q_OBJECT / Q_GADGET
...
void *graph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5graphE.stringdata0))
